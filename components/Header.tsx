...
const Header = () => {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-20 text-center">{date.getFullYear()}</p>
      <p className="text-xs text-gray-20 text-center">
        This site is designed and coded by Ni Duong
      </p>
    </div>
  );
};
